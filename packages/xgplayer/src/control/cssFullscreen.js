...
let cssFullscreen = function () {
  ...
  let btn = util.createDom('xg-cssfullscreen', `<xg-icon class="xgplayer-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
  ...
  ['click', 'touchend'].forEach(item => {
    btn.addEventListener(item, function (e) {
      e.preventDefault()
      e.stopPropagation()
      if (util.hasClass(container, 'hkplayer-cssfullscreen-active') || util.hasClass(container, 'xgplayer-is-fullscreen')) {
